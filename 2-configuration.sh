...
# Install Packages
# ------------------------------------------------------
pacman --noconfirm -S grub efibootmgr networkmanager network-manager-applet dialog wpa_supplicant xdg-user-dirs alsa-utils alsa-plugins pipewire pipewire-alsa pipewire-pulse wireplumber openssh iw dhcpcd bluez bluez-utils blueman ntp noto-fonts ttf-opensans ttf-firacode-nerd noto-fonts-emoji noto-fonts-cjk zsh rsync zip unzip ranger neofetch htop acpid grub-btrfs
